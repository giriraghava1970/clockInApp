                ...
                .map((item,index) => {
                  return(
                    <Card 
                      ...
                      onTouchEnd={() => NavigationService.navigate('PageOne',{data: item,allData:this.state.data,index:this.state.data.indexOf(this.state.data.find(val => val.id == item.id)),totalLength: this.state.data.length})} 
                    >
